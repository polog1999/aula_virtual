...
{
    // En un nuevo controlador, por ejemplo, Portal/AsistenciaController.php
...
public function index(Request $request)
{
    ...
    // Determinar qué perfiles de alumno gestiona este usuario
    ...
    return view('alumno.asistencias', compact('matriculas', 'matriculaSeleccionada', 'stats', 'asistencias'));
}
}
