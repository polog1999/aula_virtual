        ...
        <div id="dashboard-view">
            ...
            <div class="table-container">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem;">
                    <h3>Últimos alumnos modificados</h3>
                    @if (session('error'))
                ...
                <form method="GET" action="{{ route('portal.alumnos.index') }}" class="search-bar">
                            ...
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td style="white-space: nowrap;">
                                        ...
                                        {{-- <form class="delete-form" action="{{ route('portal.alumnos.destroy', $user->id) }}"
    ...
    <div id="editWorkshopModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 id="editModalTitle">Editar Alumno</h2>
            ...
            <form id="editWorkshopForm" method="POST">
                ...
                <div class="form-grid">
                    ...
                    {{-- <div class="form-group form-group-full">
                        <label>Talleres matriculados</label>
                        ...
                        <button type="button" id="addEditScheduleBtn" class="btn btn-secondary"
                            style="margin-top: 1rem;">Agregar Taller</button> --}}
                </div>
